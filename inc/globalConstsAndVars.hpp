...
namespace nf {
	...
	const nf::Vector2f SpaceshipStartSpeed(20.f, 20.f);
	const float SpaceshipRadius = 48.f, SpaceshipMass = 1.f;
	const std::string SpaceshipTextureName = "media/textures/spaceship.png", SpaceshipBulletTextureName = "media/textures/bullet.png";
